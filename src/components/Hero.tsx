...
function Hero() {
  return (
    <div id='home' className='bg-white'>
      <Header />
      <div className='lg:pl-[50px] relative bg-hero bg-cover bg-no-repeat bg-right lg:h-[662px] max-lg:py-20 flex flex-col justify-center px-5'>
        ...
        <div className="relative z-[1] max-w-[1138px] mx-auto w-full">
          ...
          <CustomBtn myClass='hover:!bg-white hover:!text-custom-red' title='Bring your idea to life!' />
        </div>
      </div>
    </div>
  )
